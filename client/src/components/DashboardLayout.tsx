...
const menuItems = [
  { icon: LayoutDashboard, label: "Store pulse", path: "/admin" },
  { icon: ShoppingBag, label: "Products", path: "/admin/products" },
  { icon: FolderTree, label: "Categories", path: "/admin/categories" },
  { icon: Warehouse, label: "Inventory", path: "/admin/inventory" },
  { icon: PackageCheck, label: "Orders", path: "/admin/orders" },
  { icon: PackageCheck, label: "Returns", path: "/admin/returns" },
  { icon: TicketPercent, label: "Coupons", path: "/admin/coupons" },
  { icon: Percent, label: "Discounts", path: "/admin/discounts" },
  { icon: FileImage, label: "Banners", path: "/admin/banners" },
